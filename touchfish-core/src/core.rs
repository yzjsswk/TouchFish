...
impl<S> TouchFishCore<S> where S: FishStorage {
    ...
    pub fn search_fish(
        ...
        self.fish_service.search_fish(fuzzy, identitys, fish_type, desc, tags, is_marked, is_locked, page_num, page_size)
    }
    ...
    pub fn detect_fish(
        ...
        self.fish_service.detect_fish(fuzzy, identitys, fish_type, desc, tags, is_marked, is_locked)
    }
